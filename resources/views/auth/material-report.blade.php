...
<head>
    ...
    <title>Raw Material Report | CaterCaptain</title>
    ...
    <div class="wrap">
        <div class="page-head">
            ...
            <div style="display: flex; gap: 16px; align-items: center; flex-wrap: wrap;">
                <span style="font-weight: 700; color: #0f172a;">Stores available: {{ $storeCount }}</span>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $material->material_price !== null ? number_format((float) $material->material_price, 2) : '-' }}
                        </td>
                        <td>
                            {{ $material->pricing_date ? \Illuminate\Support\Carbon::parse($material->pricing_date)->format('d M Y') : '-' }}
                        </td>
                        <td>
